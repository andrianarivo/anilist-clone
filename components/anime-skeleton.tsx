...
const AnimeSkeleton = () => {
	...
	return (
		<View className="m-2 rounded-2xl overflow-hidden bg-white/10">
			...
			>
				{/* Image Placeholder */}
				<Rect x="0" y="0" rx="0" ry="0" width={containerWidth} height={imageAspectHeight} />
				
				{/* Title Placeholder */}
				<Rect x="12" y={imageAspectHeight + 12} rx="4" ry="4" width={containerWidth * 0.6} height="20" />
				
				{/* Year Placeholder */}
				<Rect x="12" y={imageAspectHeight + 40} rx="4" ry="4" width="40" height="14" />
				
				{/* Rating Placeholder (Approximate position) */}
				<Rect x={containerWidth - 92} y={imageAspectHeight + 12} rx="4" ry="4" width="80" height="40" />
			</ContentLoader>
		</View>
	);
};
