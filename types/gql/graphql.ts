...
} & { " $fragmentName"?: "AnimeDetailsDataFragment" };
...
export type GetMediaQuery = {
	...
	Media?:
		| ({ __typename?: "Media" } & {
				" $fragmentRefs"?: {
					AnimeDetailsDataFragment: AnimeDetailsDataFragment;
				};
		  })
		| null;
};
...
} & { " $fragmentName"?: "MediaDataFragment" };
...
export const AnimeDetailsDataFragmentDoc = {
	kind: "Document",
	definitions: [
		{
			kind: "FragmentDefinition",
			name: { kind: "Name", value: "AnimeDetailsData" },
			typeCondition: {
				kind: "NamedType",
...
} as unknown as DocumentNode<AnimeDetailsDataFragment, unknown>;
...
} as unknown as DocumentNode<MediaDataFragment, unknown>;
