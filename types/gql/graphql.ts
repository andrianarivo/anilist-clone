...
} & { " $fragmentName"?: "MediaFragmentFragment" };
...
export type GetPopularSeasonAnimeQuery = {
	__typename?: "Query";
	Page?: {
		__typename?: "Page";
		pageInfo?: {
...
export type GetUpcomingNextSeasonAnimeQuery = {
	__typename?: "Query";
	Page?: {
		__typename?: "Page";
		pageInfo?: {
...
export type GetAllTimePopularAnimeQuery = {
	__typename?: "Query";
	Page?: {
		__typename?: "Page";
		pageInfo?: {
...
export type GetTop100AnimeQuery = {
	__typename?: "Query";
	Page?: {
		__typename?: "Page";
		pageInfo?: {
...
export type GetMostPopularQuery = {
	__typename?: "Query";
	MediaTrend?: {
		__typename?: "MediaTrend";
		date: number;
									...
									arguments: [
										{
											...
											value: { kind: "EnumValue", value: "MAIN" },
										},
									],
									selectionSet: {
										kind: "SelectionSet",
...
export const GetTrendingAnimeDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetTrendingAnime" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
									...
									arguments: [
										{
											...
											value: { kind: "EnumValue", value: "TRENDING_DESC" },
										},
										{
											kind: "Argument",
...
>;
export const GetPopularSeasonAnimeDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
								...
								},
								{
									...
									arguments: [
										...
										},
										{
											kind: "Argument",
											name: { kind: "Name", value: "sort" },
											value: { kind: "EnumValue", value: "POPULARITY_DESC" },
										},
										{
											kind: "Argument",
											name: { kind: "Name", value: "type" },
	...
	GetPopularSeasonAnimeQuery,
	GetPopularSeasonAnimeQueryVariables
>;
export const GetUpcomingNextSeasonAnimeDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetUpcomingNextSeasonAnime" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "page" } },
				...
				},
				{
					...
					variable: {
						kind: "Variable",
						name: { kind: "Name", value: "nextSeason" },
					},
					type: {
						kind: "NamedType",
						name: { kind: "Name", value: "MediaSeason" },
	...
	GetUpcomingNextSeasonAnimeQuery,
	GetUpcomingNextSeasonAnimeQueryVariables
>;
export const GetAllTimePopularAnimeDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetAllTimePopularAnime" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "page" } },
	...
	GetAllTimePopularAnimeQuery,
	GetAllTimePopularAnimeQueryVariables
>;
export const GetTop100AnimeDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
...
} as unknown as DocumentNode<GetTop100AnimeQuery, GetTop100AnimeQueryVariables>;
export const GetMostPopularDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetMostPopular" },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{
						kind: "Field",
						name: { kind: "Name", value: "MediaTrend" },
						arguments: [
							{
								kind: "Argument",
...
} as unknown as DocumentNode<GetMostPopularQuery, GetMostPopularQueryVariables>;
	...
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetAllMedia" },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{
...
} as unknown as DocumentNode<GetAllMediaQuery, GetAllMediaQueryVariables>;
export const GetWatchingDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetWatching" },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{
									...
									arguments: [
										{
											...
											value: {
												kind: "ListValue",
												values: [{ kind: "EnumValue", value: "PAUSED" }],
											},
										},
									],
									selectionSet: {
...
} as unknown as DocumentNode<GetWatchingQuery, GetWatchingQueryVariables>;
